...
const CompaniesPage = ()=>{
    ...
    // Track logo errors
    const [logoErrorMap, setLogoErrorMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$One__click$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])({});
        ...
        },
        {
            ...
            render: (logo, record)=>{
                ...
                if (!logo.startsWith("http")) {
                    const baseUrl = typeof __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$One__click$2f$src$2f$api$2f$config$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL === 'string' ? __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$One__click$2f$src$2f$api$2f$config$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["API_CONFIG"].BASE_URL.replace(/\/api\/proxy$/, '') : "";
                    const domain = baseUrl.startsWith("http") ? baseUrl : "https://appapi.1clickpolicy.com";
                    const cleanPath = logo.startsWith("/") ? logo : "/".concat(logo);
                    fullUrl = "".concat(domain).concat(cleanPath);
                }
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$One__click$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    src: fullUrl,
                    alt: "logo",
                    width: 50,
                    style: {
...
_s(CompaniesPage, "MSPMN/EbDc4DPtC/hZMk0txRgdI=", false, function() {
    return [
